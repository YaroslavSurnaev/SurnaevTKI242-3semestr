...
// Тест "Product правильно хранит цену"
...
// Тест "Кондитерское изделие — вкус и популярность"
...
// Тест "Магазин правильно запоминает заказ"
...
// Тест "Поставщик поставляет определённый товар"
...
// Тест "Производство — правильная общая стоимость"
...
// Тест "Полиморфизм — вызов правильного show()"
